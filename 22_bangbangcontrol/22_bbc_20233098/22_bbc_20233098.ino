...
#define _INTERVAL_SERIAL  59 // serial interval (unit: ms)
...
#define _DUTY_MAX 1950 // 2000
#define _DUTY_NEU 1405 // 1500
#define _DUTY_MIN 860 // 1000

#define _SERVO_ANGLE_DIFF  9  // Replace with |D - E| degree
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(100, 0.4, 0));
...
float volt_to_distance(int a_value)
{
  ...
  return 561 - (1.86 * a_value) + (1.95E-03 * pow(a_value, 2)) - (6.54E-07 * pow(a_value, 3));
}
